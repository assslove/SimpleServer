...
class MLimit : public ::google::protobuf::Message {
 public:
  ...
  inline MLimit* New() const { return New(NULL); }

  MLimit* New(::google::protobuf::Arena* arena) const;
  ...
  void InternalSwap(MLimit* other);
  private:
...
class MLimitlist : public ::google::protobuf::Message {
 public:
  ...
  inline MLimitlist* New() const { return New(NULL); }

  MLimitlist* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(MLimitlist* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
