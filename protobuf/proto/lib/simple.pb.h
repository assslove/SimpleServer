...
// repeated int32 id = 1;
inline int Simple::id_size() const {
  return id_.size();
}
inline void Simple::clear_id() {
  id_.Clear();
}
inline ::google::protobuf::int32 Simple::id(int index) const {
  // @@protoc_insertion_point(field_get:test.Simple.id)
  return id_.Get(index);
}
inline void Simple::set_id(int index, ::google::protobuf::int32 value) {
  id_.Set(index, value);
  // @@protoc_insertion_point(field_set:test.Simple.id)
}
inline void Simple::add_id(::google::protobuf::int32 value) {
  id_.Add(value);
  // @@protoc_insertion_point(field_add:test.Simple.id)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
Simple::id() const {
  // @@protoc_insertion_point(field_list:test.Simple.id)
  return id_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
Simple::mutable_id() {
  // @@protoc_insertion_point(field_mutable_list:test.Simple.id)
  return &id_;
}
